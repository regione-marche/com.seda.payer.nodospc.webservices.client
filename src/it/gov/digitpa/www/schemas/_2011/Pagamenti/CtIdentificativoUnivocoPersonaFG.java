/**
 * CtIdentificativoUnivocoPersonaFG.java
 *
...
public class CtIdentificativoUnivocoPersonaFG  implements java.io.Serializable {
    /* Campo alfanumerico che indica la natura del soggetto,  può
     * assumere i seguenti valori: */
    private it.gov.digitpa.www.schemas._2011.Pagamenti.StTipoIdentificativoUnivocoPersFG tipoIdentificativoUnivoco;
    ...
    public CtIdentificativoUnivocoPersonaFG() {
    }

    public CtIdentificativoUnivocoPersonaFG(
           it.gov.digitpa.www.schemas._2011.Pagamenti.StTipoIdentificativoUnivocoPersFG tipoIdentificativoUnivoco,
    ...
    /**
     * Gets the tipoIdentificativoUnivoco value for this CtIdentificativoUnivocoPersonaFG.
     * 
     * @return tipoIdentificativoUnivoco   * Campo alfanumerico che indica la natura del soggetto,  può
     * assumere i seguenti valori:
     */
    public it.gov.digitpa.www.schemas._2011.Pagamenti.StTipoIdentificativoUnivocoPersFG getTipoIdentificativoUnivoco() {
        return tipoIdentificativoUnivoco;
    }


    /**
     * Sets the tipoIdentificativoUnivoco value for this CtIdentificativoUnivocoPersonaFG.
     * 
     * @param tipoIdentificativoUnivoco   * Campo alfanumerico che indica la natura del soggetto,  può
     * assumere i seguenti valori:
     */
    public void setTipoIdentificativoUnivoco(it.gov.digitpa.www.schemas._2011.Pagamenti.StTipoIdentificativoUnivocoPersFG tipoIdentificativoUnivoco) {
        this.tipoIdentificativoUnivoco = tipoIdentificativoUnivoco;
    }


    /**
     * Gets the codiceIdentificativoUnivoco value for this CtIdentificativoUnivocoPersonaFG.
     * 
    ...
    /**
     * Sets the codiceIdentificativoUnivoco value for this CtIdentificativoUnivocoPersonaFG.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof CtIdentificativoUnivocoPersonaFG)) return false;
        CtIdentificativoUnivocoPersonaFG other = (CtIdentificativoUnivocoPersonaFG) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(CtIdentificativoUnivocoPersonaFG.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.digitpa.gov.it/schemas/2011/Pagamenti/", "ctIdentificativoUnivocoPersonaFG"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.digitpa.gov.it/schemas/2011/Pagamenti/", "stTipoIdentificativoUnivocoPersFG"));
